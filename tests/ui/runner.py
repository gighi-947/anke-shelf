...
def main() -> int:
    ...
    api = Api(books=books, shelf=shelf, progress=progress, settings=settings,
              ...
              gululu_service=GululuService(_register_nga_book, shelf=shelf, books=books),
    ...
    (async () => {
      ...
      try {
        ...
        L('update_defaults:' + (
          document.getElementById('dl-update-author-only') &&
          document.getElementById('dl-update-author-only').checked === false ? 1 : 0
        ));
