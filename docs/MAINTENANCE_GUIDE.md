...
| --- | --- | --- |
| Windows Python | 339 项（2026-08-24 实跑全过） | `python -m unittest discover tests` |
...
| Android JVM | 236 项（235 过 / 1 跳）+ DisciplineTest 11 项 | `cd android && gradlew.bat testDebugUnitTest` |
