...
| JS 契约 | textpos 15 例、api-contract 59 方法、launch 诊断、bridge v1（能力含 annotation）、parts 7/45559B、reader-lite-textpos 跨端折叠 12 例、reader-session、nga-cookie OK | `node contracts/tests/*.test.js` + `node tests/js/*.test.js` |
| Android JVM | 135 项（134 过 / 1 跳）+ DisciplineTest 8 项 | `cd android && gradlew.bat testDebugUnitTest` |
