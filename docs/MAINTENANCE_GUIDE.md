...
| --- | --- | --- |
| Windows Python | 321 项（3.14：全过；bundled 3.12 全过） | `python -m unittest discover tests` |
...
| Android JVM | 148 项（147 过 / 1 跳）+ DisciplineTest 8 项 | `cd android && gradlew.bat testDebugUnitTest` |
