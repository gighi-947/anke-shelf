...
| 项 | 现状 |
| --- | --- |
| 功能基线 | `44c17b4`（win: P3 存储恢复能力；2026-08-14 核对） |
| 分支 | `main`，本地领先 `origin/main` 1 提交（`44c17b4` 待推送） |
| Windows Python 单测 | 221 项 OK（3.12 / 3.14 双环境实测） |
...
> parts 不入 APK。Kotlin 大屏拆分与 Windows 前端拆分待办。
